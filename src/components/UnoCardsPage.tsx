  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img1,
      caption: "Ninna food love ge yaaru thakkare illa! 🍕🍟 I imagine you smiling wide when your favorite food is in front of you. 'Thindi bandre Parvati happy!' 😋",
    ...
    },
    {
      ...
      number: "2",
      photoUrl: Img2,
      caption: "You may be quiet, but your thoughts travel continents! ✈️🌍 I imagine you exploring new places silently, full happy vibes with travel playlist on.",
      musicName: "prem_ki_kahani.......",
      musicUrl: Music2,
    },
    {
      color: "bg-green-500",
      number: "3",
      photoUrl: Img3,
      caption: "Ninna introvert nature is your superpower. 😌 You don’t talk much, but when you do, it's gold. Idakke naanu full-time speaker! 😂",
      musicName: "Perfect",
      musicUrl: Music3,
    },
    {
      ...
      number: "4",
      photoUrl: Img4,
      caption: "One wish — always be happy no matter what! 🌻 Ninna silent smile nalli tumba positivity ide. Just stay the same, forever Parvati. 💛",
      musicName: "O Rangrez",
      musicUrl: Music4,
    },
